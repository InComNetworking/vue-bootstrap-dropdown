...
var clickOutSide = function(event) {
  for (var i in DropDownInstances) {
    ...
    var fn2 = DropDownInstances[i].fn;
    if (event.target !== el && !el.contains(event.target)) {
      processFN(fn2, event);
    }
  }
};
var processFN = function(fn2, event) {
  if (!fn2) {
    return;
  }
  setTimeout(function() {
...
const _hoisted_1 = ["id", "aria-expanded"];
const _hoisted_2 = { class: "btn-group" };
const _hoisted_3 = ["id"];
const _hoisted_4 = ["aria-expanded"];
const _hoisted_5 = /* @__PURE__ */ createElementVNode("span", { class: "visually-hidden" }, "Toggle Dropdown", -1);
const _hoisted_6 = [
  _hoisted_5
];
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("div", {
    class: normalizeClass(["dropdown", { show: $data.isShow }])
  }, [
    !_ctx.btnSplit ? (openBlock(), createElementBlock("button", {
      key: 0,
      class: normalizeClass(["btn dropdown-toggle", _ctx.btnClass]),
      type: "button",
      "data-toggle": "dropdown",
      "aria-haspopup": "true",
      id: _ctx.id,
      ref: "button",
      onClick: _cache[0] || (_cache[0] = (...args) => $options.switchState && $options.switchState(...args)),
      "aria-expanded": $data.isShow
    }, toDisplayString($props.title), 11, _hoisted_1)) : createCommentVNode("", true),
    createElementVNode("div", _hoisted_2, [
      _ctx.btnSplit ? (openBlock(), createElementBlock("button", {
        key: 0,
        class: normalizeClass(["btn", _ctx.btnClass]),
        type: "button",
        "data-toggle": "dropdown",
        "aria-haspopup": "true",
        id: _ctx.id,
        ref: "button"
      }, toDisplayString($props.title), 11, _hoisted_3)) : createCommentVNode("", true),
      _ctx.btnSplit ? (openBlock(), createElementBlock("button", {
        key: 1,
        class: normalizeClass(["btn dropdown-toggle dropdown-toggle-split", _ctx.btnClass]),
        type: "button",
        "data-toggle": "dropdown",
        "aria-haspopup": "true",
        "aria-expanded": $data.isShow,
        onClick: _cache[1] || (_cache[1] = (...args) => $options.switchState && $options.switchState(...args))
      }, _hoisted_6, 10, _hoisted_4)) : createCommentVNode("", true)
    ]),
    createElementVNode("div", {
      class: normalizeClass(["dropdown-menu", $options.dropdownClassComputed]),
      ref: "popup",
      "data-bs-popper": "static",
      "aria-labelledby": _ctx.id,
      onClick: _cache[2] || (_cache[2] = (...args) => $options.switchState && $options.switchState(...args))
    }, [
      renderSlot(_ctx.$slots, "default", { dropdown: $options.dropdownPointer })
    ], 10, _hoisted_7)
  ], 2);
}
var BootstrapDropdown = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render]]);
export { BootstrapDropdown as default };
